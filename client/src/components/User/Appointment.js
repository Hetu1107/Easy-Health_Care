...
function Appointment (props) {
    ...
    useEffect(() => {
        if (props.account === '0x34c9C9F9191b0c215F8654064BDF2A35aa755e8D') {
            document.getElementsByClassName('appointment_page_user')[0].style.hidden = true;
        }
    });
    ...
    return (
        <div className = "appointment_page_user">
            {props.account !== '0x34c9C9F9191b0c215F8654064BDF2A35aa755e8D' ?
                ...
                : <AppointMentAdmin zero = {predicted} predicted = {setPredicted} hospital = {props.hospital}
